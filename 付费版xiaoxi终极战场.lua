...
local _F = {
    ...
    Cfg = {
        Enabled = false,
        Range = 9999, -- 全图范围（无需修改）
        Friends = true, -- true=忽略好友，false=不忽略
        Target = "Closest" -- 优先攻击最近目标
    },
    Data = {
        List = {},
        Idx = 1,
...
function _F.Start()
    ...
    _F.Data.KCon = _F.R.Heartbeat:Connect(function()
        ...
        _F.Aura(cn == "Gon" and 20 or 50) -- Gon角色20连击，其他角色50连击
    end)
end
