...
Library:Notify({
    Title = "XIAOXI HUB",
    Description = "欢迎付费用户: " .. playerName .. " 丨 正在加载XIAOXI终极战场",
    Time = 6
})
local startTime = tick()      
loadstring(game:HttpGet('https://raw.githubusercontent.com/xiaoxi9008/Server./refs/heads/main/付费版xiaoxi终极战场.lua'))()
local endTime = tick()
